...
const MonthlyVehicleTable = ({ monthlyData, selectedYear, setSelectedYear, loading, exportExcel = false }) => {
  ...
  const generateMonthlyRows = () => {
    ...
    vehicleData?.dailyData?.map((monthItem, index) => {
      ...
      rows.push(
        <tr key={`month-${index}`} className={index % 2 === 0 ? 'bg-base-200' : 'bg-base-100'}>
          <td className="border-2 text-sm text-center">{monthItem.month}</td>
          <td className="border-2 text-sm text-center">{monthItem.workDays}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.sm)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.mp)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.tr)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.aup)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.bs)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.ts)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.bb)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.tb)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.gandengSemitrailer)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.ktb)}</td>
          <td className="border-2 text-sm text-center">{formatNumber(monthlyTotal.total)}</td>
        </tr>
      );
    });
    ...
    //       <td colSpan={2} className="border-2 text-sm text-center">{lhrk.period}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.sm || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.mp || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.aup || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.trMp || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.bs || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.ts || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.bb || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.tb || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.gandengSemitrailer || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.ktb || 0}</td>
    //       <td className="border-2 text-sm text-center">{lhrk.data?.total || 0}</td>
    //     </tr>
    //   );
    // });
    ...
    //     <td colSpan={2} className="border-2 text-sm text-center">LHRKT</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.sm}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.mp}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.aup}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.trMp}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.bs}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.ts}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.bb}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.tb}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.gandengSemitrailer}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.ktb}</td>
    //     <td className="border-2 text-sm text-center">{lhrkTotal.total}</td>
    //   </tr>
    // );
