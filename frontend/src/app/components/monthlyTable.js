  ...
  const generateMonthlyRows = () => {
    ...
    vehicleData.monthlyData.map((month, index) => {
      rows.push(
        <tr key={`month-${index}`} className={index % 2 === 0 ? 'bg-base-200' : 'bg-base-100'}>
          <td className="border border-base-300 text-sm text-center">{month.month}</td>
          <td className="border border-base-300 text-sm text-center">{month.workDays}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.sm || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.mp || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.aup || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.trMp || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.bs || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.ts || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.bb || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.tb || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.gandengSemitrailer || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.ktb || ''}</td>
          <td className="border border-base-300 text-sm text-center">{month.data.total || ''}</td>
        </tr>
      );
    });
    ...
    rows.push(
      <tr key="year-total" className="bg-base-300 font-medium">
        ...
        <td className="border border-base-300 text-sm text-center"></td>
        <td className="border border-base-300 text-sm text-center"></td>
        <td className="border border-base-300 text-sm text-center"></td>
        <td className="border border-base-300 text-sm text-center"></td>
        <td className="border border-base-300 text-sm text-center"></td>
    ...
    vehicleData.lhrkData.map((lhrk, index) => {
      rows.push(
        <tr key={`lhrk-${index}`} className={index % 2 === 0 ? 'bg-base-200' : 'bg-base-100'}>
          ...
          <td className="border border-base-300 text-sm text-center">{lhrk.data.sm || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.mp || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.aup || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.trMp || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.bs || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.ts || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.bb || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.tb || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.gandengSemitrailer || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.ktb || ''}</td>
          <td className="border border-base-300 text-sm text-center">{lhrk.data.total || ''}</td>
        </tr>
      );
    });
